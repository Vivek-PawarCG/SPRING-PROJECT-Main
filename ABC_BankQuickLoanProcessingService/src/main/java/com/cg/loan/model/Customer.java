...
public class Customer extends User {
	...
	@NotEmpty(message = "Annual Salary can't be empty!")
	@Size(min = 5, max = 10, message = "Please enter annual salary")
	//@Pattern(regexp = "^[a-zA-Z]*$", message = "Accepts only alphabets! re-enter the salary")
	//@Pattern(regexp = "^\\d{10}$", message = "Invalid input:Enter numbers only")
	...
	public Customer(String customerName, String mobileNumber, String emailId, LocalDate dateOfBirth, String gender,
			String annualSalary, String aadharNumber, String panNumber) {
		super();
	...
	public Customer(int userId, String password, String role, String customerName, String mobileNumber, String emailId,
			LocalDate dateOfBirth, String gender, String annualSalary, String aadharNumber, String panNumber) {
		super(userId, password, role);
		this.customerName = customerName;
		this.mobileNumber = mobileNumber;
		this.emailId = emailId;
	...
	public String toString() {
		return "Customer [customerName=" + customerName + ", mobileNumber=" + mobileNumber + ", emailId=" + emailId
				+ ", dateOfBirth=" + dateOfBirth + ", gender=" + gender + ", annualSalary=" + annualSalary
