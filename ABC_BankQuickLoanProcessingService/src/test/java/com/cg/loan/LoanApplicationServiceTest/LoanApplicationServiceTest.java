...
class LoanApplicationServiceTest {
	...
	void testaddLoanApplication() {
		...
		LoanApplication input = new LoanApplication(101, LocalDate.parse("2020-01-08"), null, 190000, 900000, false, false, Status.APPROVED);
	...
	@Test
	// Testing get all loan applications by passing all the required parameters
	...
	void testViewLoanApplicationById() throws InvalidLoanApplicationException {
	...
	void deleteLoanApplication() throws InvalidLoanApplicationException {
		...
		LoanApplication input = new LoanApplication(101, LocalDate.parse("2020-01-08"), null, 190000, 90000, false, false, null);

		LoanApplication output = new LoanApplication(101, LocalDate.parse("2020-01-08"), null, 190000, 90000, false, false, null);
